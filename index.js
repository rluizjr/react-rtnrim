...
import { SidebarComponent, TreeViewComponent, ToolbarComponent, ItemsDirective, ItemDirective } from '@syncfusion/ej2-react-navigations';
...
export class Default extends SampleBase {
    ...
    treeFields = { dataSource: this.treeData, id: "id", text: "name", selected: "selected", parentID: "pid", hasChildren: "hasChild", expanded: "expanded" };
    listTemplate(data) {
    ...
    render() {
        ...
        let folderEle = '<div class= "e-folder"><div class= "e-folder-name">Webmail</div></div>';
        let userNameEle = '<div><div class= "e-user-name">John</div></div>';
        let imageEle = '<div class= "image-container"><img height="20px" src="https://ej2.syncfusion.com/react/demos/src/sidebar/images/user.svg" alt="John"></img></div>';
        //ListView Fields Mapping
        let fields = { id: "id", text: "text" };
        return (<div className="control-section" id="sidebar-wrapper">
                ...
                <div className="maincontent">
                    <ListViewComponent id="listView" ref={ListView => this.listObj = ListView} template={this.listTemplate} cssClass="e-list-template" dataSource={this.inboxData} fields={fields} select={this.onListSelect.bind(this)}>
                    </ListViewComponent>
                </div>
